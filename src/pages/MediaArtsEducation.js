                                    ...
                                    color: 'warning',
                                        ...
                                        '&:hover': {
                                            ...
                                            boxShadow: `0 12px 24px rgba(0, 0, 0, 0.15)`,
                                                ...
                                                mx: 'auto',
                                                mb: 2,
                                            }, children: _jsx(Box, { sx: { color: `${benefit.color}.main`, fontSize: 32 }, children: benefit.icon }) }), _jsx(Typography, { variant: "h6", sx: { fontWeight: 700, mb: 1.5 }, children: benefit.title }), _jsx(Typography, { variant: "body2", color: "text.secondary", sx: { lineHeight: 1.7 }, children: benefit.description })] }) }, index))) }), _jsx(Box, { sx: { textAlign: 'center', mt: 6 }, children: _jsx(Button, { component: Link, to: "/programs-workshops", variant: "contained", size: "large", startIcon: _jsx(CheckCircleIcon, {}), endIcon: _jsx(ArrowForwardIcon, {}), onClick: () => {
                                    setSatisfactionMetrics((prev) => ({ ...prev, interactions: prev.interactions + 1 }));
                                }, sx: {
                                    px: 6,
                                    py: 2,
