...
export default function Latest() {
    ...
    return (_jsxs("div", { children: [_jsx(Typography, { variant: "h2", gutterBottom: true, children: "Latest" }), _jsx(Grid, { container: true, spacing: 8, columns: 12, sx: { my: 4 }, children: articleInfo.map((article, index) => (_jsx(Grid, { size: { xs: 12, sm: 6 }, children: _jsxs(Box, { sx: {
                            display: 'flex',
                            flexDirection: 'column',
                            justifyContent: 'space-between',
                            gap: 1,
                            height: '100%',
                        }, children: [_jsx(Typography, { gutterBottom: true, variant: "caption", component: "div", children: article.tag }), _jsxs(TitleTypography, { gutterBottom: true, variant: "h6", onFocus: () => handleFocus(index), onBlur: handleBlur, tabIndex: 0, className: focusedCardIndex === index ? 'Mui-focused' : '', children: [article.title, _jsx(NavigateNextRoundedIcon, { className: "arrow", sx: { fontSize: '1rem' } })] }), _jsx(StyledTypography, { variant: "body2", color: "text.secondary", gutterBottom: true, children: article.description }), _jsx(Author, { authors: article.authors })] }) }, index))) }), _jsx(Box, { sx: { display: 'flex', flexDirection: 'row', pt: 4 }, children: _jsx(Pagination, { hidePrevButton: true, hideNextButton: true, count: 10, boundaryCount: 10 }) })] }));
}
