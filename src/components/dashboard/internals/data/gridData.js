...
function renderSparklineCell(params) {
    ...
    return (_jsx("div", { style: { display: 'flex', alignItems: 'center', height: '100%' }, children: _jsx(SparkLineChart, { data: value, width: colDef.computedWidth || 100, height: 32, plotType: "bar", showHighlight: true, showTooltip: true, colors: ['hsl(210, 98%, 42%)'], xAxis: {
                scaleType: 'band',
                data,
            } }) }));
}
function renderStatus(status) {
    ...
    return _jsx(Chip, { label: status, color: colors[status], size: "small" });
}
