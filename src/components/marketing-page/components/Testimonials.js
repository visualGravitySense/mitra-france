...
const userTestimonials = [
    {
        avatar: _jsx(Avatar, { alt: "Remy Sharp", src: "/static/images/avatar/1.jpg" }),
        name: 'Remy Sharp',
...
export default function Testimonials() {
    ...
    return (_jsxs(Container, { id: "testimonials", sx: {
            pt: { xs: 4, sm: 12 },
            pb: { xs: 8, sm: 16 },
            position: 'relative',
            display: 'flex',
            ...
            gap: { xs: 3, sm: 6 },
                ...
                }, children: [_jsx(Typography, { component: "h2", variant: "h4", gutterBottom: true, sx: { color: 'text.primary' }, children: "Testimonials" }), _jsx(Typography, { variant: "body1", sx: { color: 'text.secondary' }, children: "See what our customers love about our products. Discover how we excel in efficiency, durability, and satisfaction. Join us for quality, innovation, and reliable support." })] }), _jsx(Grid, { container: true, spacing: 2, children: userTestimonials.map((testimonial, index) => (_jsx(Grid, { size: { xs: 12, sm: 6, md: 4 }, sx: { display: 'flex' }, children: _jsxs(Card, { variant: "outlined", sx: {
                            display: 'flex',
                            flexDirection: 'column',
                            justifyContent: 'space-between',
                            flexGrow: 1,
                        }, children: [_jsx(CardContent, { children: _jsx(Typography, { variant: "body1", gutterBottom: true, sx: { color: 'text.secondary' }, children: testimonial.testimonial }) }), _jsxs(Box, { sx: {
                                    display: 'flex',
                                    flexDirection: 'row',
                                    justifyContent: 'space-between',
                                }, children: [_jsx(CardHeader, { avatar: testimonial.avatar, title: testimonial.name, subheader: testimonial.occupation }), _jsx("img", { src: logos[index], alt: `Logo ${index + 1}`, style: logoStyle })] })] }) }, index))) })] }));
}
